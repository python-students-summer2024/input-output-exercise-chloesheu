...
def get_favorite_vegetable():
    ...
    """
    favoriteVeg = input("What is your favorite vegetable?")
    print("Interesting! I also love " + favoriteVeg + "!")
...
def get_favorite_number():
    ...
    """
    favoriteNum = input("What is your favorite number?")
    print("Interesting! I also love " + favoriteNum + "!")
...
def get_name_and_age():
    ...
    age = input("What is your zodiac sign?")
    print("Interesting! My name is also " + userName + ", and I'm also " + age + " years old!")
